...
class menuCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        burgerName.anchor(top: contentView.topAnchor, left: contentView.leftAnchor, paddingTop: 40, paddingLeft: 20)
        
        contentView.addSubview(price)
        price.anchor(left: contentView.leftAnchor, bottom: contentView.bottomAnchor, paddingLeft: 20, paddingBottom: 10)
    }
