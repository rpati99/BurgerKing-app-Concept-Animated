...
class ItemDetailsViewController: UIViewController {
    ...
    @objc private func presentAnimation() {
    ...
    private func animateStars(content: UIView, delay: Double) {
    ...
    private func animateContents() {
        ...
        animateStars(content: star1, delay: 0.0)
        animateStars(content: star2, delay: 0.1)
        animateStars(content: star3, delay: 0.2)
        animateStars(content: star4, delay: 0.3)
        animateStars(content: star5, delay: 0.4)
    ...
    private func setupUI() {
        ...
        name.anchor(top: view.safeAreaLayoutGuide.topAnchor, left: view.leftAnchor, paddingTop: 10, paddingLeft: 20)
        
        view.addSubview(cardView)
        cardView.setDimensions(width: view.frame.width, height: view.frame.height - 100)
